...
public class ACPPacket {
  ...
  public void setHeader(byte HeaderLen, byte majorVer, byte minorVer, String ACPCmd,
  ...
  public void setHeader(String ACPCmd, String ConnID, String targetMAC, byte PayloadSize) {
  ...
  public void setCommand(String ACPCmd) {
    ...
    setCommand(HexToByte(ACPCmd.substring(2, 4))[0], HexToByte(ACPCmd.substring(0, 2))[0]);
    // lowbyte, highbyte
  }
  ...
  protected static String bufferToHex(byte buffer[], int startOffset, int length) {
